...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Other banks</a></li>
        </ol>
    </div>
                        ...
                        <table id="tbl_transfer_logs" class="display min-w850">
                            ...
                            @foreach($transfer as $k=>$val)
                                <tr>
                                    ...
                                    <td>
                                        @if($val->type==0)
                                            <span class="badge light badge-danger">Credit</span>
                                        @elseif($val->type==1)
                                            <span class="badge light badge-success">Debit</span>
                                        @endif
                                    </td>
                                    <td>{{$val->details}}</td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if($val->status==0)
                                                        <a class='dropdown-item'
                                                           href="{{url('/')}}/admin/app-otherbank/{{$val->id}}"><i
                                                                class="icon-thumbs-up3 mr-2"></i>Approve</a>
                                                    @endif
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{url('/')}}/admin/other-bank/delete/{{$val->id}}"
