    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#tbl_approved_deposits').DataTable({
                language: {
                    emptyTable: "No declined deposits available",
                    info: "Showing _START_ to _END_ of _TOTAL_ declined deposits",
                    infoEmpty: "Showing 0 to 0 of 0 declined deposits",
                    infoFiltered: "(filtered from _MAX_ total declined deposits)",
                    infoPostFix: "",
                    thousands: ",",
                    lengthMenu: "Show _MENU_ declined deposits",
                    loadingRecords: "<div class='loader slim'></div>",
                    processing: "<div class='loader slim'></div>",
                    search: "Search declined deposits:",
                    zeroRecords: "No declined deposits match search criteria"
                },
            });
...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Declined deposits</a></li>
        </ol>
    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{url('/')}}/admin/deposit/delete/{{$val->id}}"
