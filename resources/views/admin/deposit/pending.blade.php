...
@push('extra-js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#tbl_pending_deposits').DataTable({
                language: {
                    emptyTable: "No pending deposits available",
                    info: "Showing _START_ to _END_ of _TOTAL_ pending deposits",
                    infoEmpty: "Showing 0 to 0 of 0 pending deposits",
                    infoFiltered: "(filtered from _MAX_ total pending deposits)",
                    infoPostFix: "",
                    thousands: ",",
                    lengthMenu: "Show _MENU_ pending deposits",
                    loadingRecords: "<div class='loader slim'></div>",
                    processing: "<div class='loader slim'></div>",
                    search: "Search pending deposits:",
                    zeroRecords: "No pending deposits match search criteria"
                },
            });
...
<div class="page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="#">Pending deposits</a></li>
    </ol>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="tbl_pending_deposits" class="display min-w850">
                        <thead>
                        <tr>
                            <th>S/N</th>
                            <th>Name</th>
