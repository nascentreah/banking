...
@push('extra-js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#tbl_pending_loans').DataTable({
                language: {
                    emptyTable: "No pending loans available",
                    info: "Showing _START_ to _END_ of _TOTAL_ pending loans",
                    infoEmpty: "Showing 0 to 0 of 0 pending loans",
                    infoFiltered: "(filtered from _MAX_ total pending loans)",
                    infoPostFix: "",
                    thousands: ",",
                    lengthMenu: "Show _MENU_ pending loans",
                    loadingRecords: "<div class='loader slim'></div>",
                    processing: "<div class='loader slim'></div>",
                    search: "Search pending loans:",
                    zeroRecords: "No pending loans match search criteria"
                },
            });
...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Pending loans</a></li>
        </ol>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tbl_pending_loans" class="display min-w850">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Name</th>
