...
@push('extra-js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#tbl_completed_plans').DataTable({
                language: {
                    emptyTable: "No completed plans available",
                    info: "Showing _START_ to _END_ of _TOTAL_ completed plans",
                    infoEmpty: "Showing 0 to 0 of 0 completed plans",
                    infoFiltered: "(filtered from _MAX_ total completed plans)",
                    infoPostFix: "",
                    thousands: ",",
                    lengthMenu: "Show _MENU_ completed plans",
                    loadingRecords: "<div class='loader slim'></div>",
                    processing: "<div class='loader slim'></div>",
                    search: "Search completed plans:",
                    zeroRecords: "No completed plans match search criteria"
                },
            });
...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Completed Plans</a></li>
        </ol>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tbl_completed_plans" class="display min-w850">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Ref</th>
