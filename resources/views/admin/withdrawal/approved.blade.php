...
@push('extra-js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#tbl_unpaid_withdraws').DataTable({
                language: {
                    emptyTable: "No unpaid withdraws available",
                    info: "Showing _START_ to _END_ of _TOTAL_ unpaid withdraws",
                    infoEmpty: "Showing 0 to 0 of 0 unpaid withdraws",
                    infoFiltered: "(filtered from _MAX_ total unpaid withdraws)",
                    infoPostFix: "",
                    thousands: ",",
                    lengthMenu: "Show _MENU_ unpaid withdraws",
                    loadingRecords: "<div class='loader slim'></div>",
                    processing: "<div class='loader slim'></div>",
                    search: "Search unpaid withdraws:",
                    zeroRecords: "No unpaid withdraws match search criteria"
                },
            });
...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="#">Approved withdraws</a></li>
        </ol>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Approved withdraws</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tbl_unpaid_withdraws" class="display min-w850">
                            <thead>
                            <tr>
                                <th>S/N</th>
                                <th>Name</th>
