...
<div class="main-content" style="background-image: url('https://www.binancemerchantpay.com/homebags.jpg');">
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0 p-3 mb-2 bg-transparent text-dark">
                ...
                <div class="form-group mb-3">
                   ...
                   <div class="form-group mb-3">
                      ...
                      <div class="input-group input-group-merge input-group-alternative">
                        <div class="input-group-prepend">
                          <span class="input-group-text"><i class="ni ni-planet"></i></span>
                            ...
                            <select  name="currency" required class="form-control" dropdown="100" placeholder="Sorce">
                    <option value="" disable selected>Source of income</option>
                    ...
                    <option value="">Life insurance</option>
                                        <option value=";">Divorce settlement</option> 
 ...
 <select  class="form-control"  name="account_type" required class="form-control" dropdown="100">
                             <option value="Occupation" disable>Occupation</option>

                    <option value="Standard">Administrative / Office</option>
                    <option value="Classic">Architecture / Engineering</option>
                    <option value="Premium">Art / Media / Design</option>
                    <option value="Cryptocurrencies">Business / Management</option>
                    <option value="NFP">Constructive / Extraction / Industrail</option>
                    <option value="FOMC">Customer Service</option>
                                        <option value="FOMC">Education / Training / Libarary</option>
                                                            <option value="FOMC">Entertainment</option>
                                                                                <option value="FOMC">Farming / Fishing / Forestry</option>
                    <option value="FOMC">Finance / Accounting</option>
