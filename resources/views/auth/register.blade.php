...
@section('content')
            ...
            <form role="form" action="{{route('submitregister')}}" method="post">
                ...
                <div class="form-group">
                    <div class="input-group input-group-merge input-group-alternative">
                        ...
                        <select name="currency" required class="form-control" dropdown="100"
                                placeholder="Sorce">
                ...
                <div class="form-group">
                    <div class="input-group input-group-merge input-group-alternative">
                        ...
                        <select class="form-control" name="account_type" required
                                class="form-control" dropdown="100">
    ...
    {{--                    <div class="row mt-3">--}}
    {{--                        <div class="col-6">--}}
    {{--                            <a href="{{route('user.password.request')}}" class="text-dark"><small>Forgot--}}
    {{--                                    password?</small></a>--}}
    {{--                        </div>--}}
